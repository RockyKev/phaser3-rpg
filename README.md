...
3. Once it's picked, it adds the data to GameManager->sceneChests[chestId]. Then we are actually sending over a callback function from GameManager called `addChest()`. 
